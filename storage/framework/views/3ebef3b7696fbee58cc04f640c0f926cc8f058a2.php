            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <div class="grid lg:grid-cols-5 gap-3">
                        <div class="mt-1">
                            <a class="p-3 bg-blue-500 hover:bg-blue-400 rounded-md text-white " href="<?php echo e(route('posts.create')); ?>">
                                Create Post
                            </a>
                        </div>
                    </div>
				...
				<tbody>
					...
					<tr
						...
						<td class="px-6 py-4 text-right">
							<a href="<?php echo e(route("posts.edit", $post)); ?>" class="p-3 m-3 bg-green-500 hover:bg-green-400 text-white">Edit</a>
						</td>
                        <td class="px-6 py-4 text-right">
